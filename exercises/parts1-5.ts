...
console.log(`Name: ${spacecraftName}   Days to Mars: ${daysToMars}`);
...
console.log(`Name: ${spacecraftName}   Days to Mars: ${getDaysToLocation(kilometersToMars)}`);
console.log(`Name: ${spacecraftName}   Days to Moon: ${getDaysToLocation(kilometersToTheMoon)}`);
