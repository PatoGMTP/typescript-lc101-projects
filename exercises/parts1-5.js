...
console.log("Name: ".concat(spacecraftName, "   Days to Mars: ").concat(daysToMars));
...
console.log("Name: ".concat(spacecraftName, "   Days to Mars: ").concat(getDaysToLocation(kilometersToMars)));
console.log("Name: ".concat(spacecraftName, "   Days to Moon: ").concat(getDaysToLocation(kilometersToTheMoon)));
